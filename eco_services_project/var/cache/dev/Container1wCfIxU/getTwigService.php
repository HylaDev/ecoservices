...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Twig/CountCart.php';
        ...
        $instance->addExtension(new \App\Twig\CountCart(($container->privates['App\\Service\\CartService'] ?? $container->load('getCartServiceService'))));
