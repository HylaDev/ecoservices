...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/MyFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\MyFixtures(($container->privates['App\\Repository\\ProductCategoryRepository'] ?? $container->load('getProductCategoryRepositoryService'))), 'groups' => []]]);
